...
*	==29077== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
*	==29077== Using Valgrind-3.18.1 and LibVEX; rerun with -h for copyright info
*	==29077== Command: ./reverse ./input/example-sorted.in
*	==29077== 
*	Original: [-1, 0, 2, 3, 8]
*	Reversed: [8, 3, 2, 0, -1]
*	==29077== 
*	==29077== HEAP SUMMARY:
*	==29077==     in use at exit: 0 bytes in 0 blocks
*	==29077==   total heap usage: 8 allocs, 8 frees, 5,684 bytes allocated
*	==29077== 
*	==29077== All heap blocks were freed -- no leaks are possible
*	==29077== 
*	==29077== For lists of detected and suppressed errors, rerun with: -s
